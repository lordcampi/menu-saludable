...
class PreciosActualizados:
    ...
    def _obtener_precios_semanales(self):
        """
        PRECIOS APROXIMADOS - Actualizar semanalmente
        Fuente: Promedio supermercados (Exito, D1, Ara, Jumbo)
        Ultima actualizacion: Junio 2026
        """
        precios = {
            # Proteinas (precio por kg o unidad)
            "gallina": 12000,
            "pechuga_pollo": 18500,
            "carne_mechar": 22000,
            "bistec_res": 24000,
    ...
    def ajustar_precios_por_ciudad(self, ciudad):
        """Ajusta precios segun la ciudad"""
        factores = {
            "Bogota": 1.0,
            "Medellin": 0.95,
            "Cali": 0.93,
    ...
    def calcular_costo_lista(self, lista_compras):
        """Calcula el costo total aproximado de la lista de compras"""
        costo_total = 0
        desglose = {}
