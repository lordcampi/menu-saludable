...
CAMBIOS_ESPERADOS = {
    ...
    "des_01": "Salchichas con arepa",
    "des_02": "Huevos en cacerola con tortilla de trigo",
    "des_07": "Arepas con atun",
...
def test_sustituciones_eliminan_ingredientes_anteriores():
    ingredientes_antiguos = {
        ...
        "des_01": {"aguacate", "tomate", "cebolla_larga", "cilantro", "huevo"},
        "des_02": {"arepa"},
        "des_07": {"queso_mozarella", "jamon"},
        ...
        "alm_08": {"pimenton"},
        "alm_09": {"carne_molida", "pan_hamburguesa", "papa_francesa", "pimienta", "mostaza"},
        "alm_10": {"higado_res", "tomate"},
        "alm_12": {"platano_verde"},
        "alm_14": {"arroz", "papa_francesa"},
        "alm_15": {"pimenton"},
        "cen_03": {"champiñones", "huevo", "jamon", "mostaza"},
